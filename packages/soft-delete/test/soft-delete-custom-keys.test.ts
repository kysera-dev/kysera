  ...
  describe('Composite Primary Keys', () => {
    it('should handle soft delete for composite key tables via direct query', async () => {
      ...
      const result = await orm
        .applyPlugins(db.selectFrom('order_items').selectAll(), 'select', 'order_items', {})
        .execute()
  ...
  describe('Mixed Primary Key Scenarios', () => {
    ...
    it('should not affect tables not in the configured list', async () => {
      ...
      const products = await orm
        .applyPlugins(db.selectFrom('products').selectAll(), 'select', 'products', {})
        .execute()
      ...
      const customers = await orm
        .applyPlugins(db.selectFrom('customers').selectAll(), 'select', 'customers', {})
        .execute()
