...
// eslint-disable-next-line max-lines-per-function -- Comprehensive edge case testing requires extensive test suite
describe('Audit Plugin Edge Cases and Error Handling', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle restoreFromAudit with non-existent audit log', async () => {
      await expect(userRepo.restoreFromAudit(99999)).rejects.toThrow('AuditLog not found')
    })
