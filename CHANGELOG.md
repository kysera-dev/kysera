...
- feat: comprehensive audit and optimization of all kysera packages

### 🐛 Bug Fixes

- fix: ensure full Deno and Bun runtime compatibility across all packages
...
- chore: upgrade kysely to 0.28.12 and update all dependencies to latest versions
- ci: remove release.yml workflow
- ci: fix GitHub Pages deployment, update README
...
- fix: comprehensive codebase audit — cross-database compatibility, test coverage, and documentation sync
