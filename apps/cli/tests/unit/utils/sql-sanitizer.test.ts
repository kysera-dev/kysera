...
describe('validateIdentifier', () => {
  ...
  describe('invalid identifiers - throws SqlSanitizationError', () => {
    ...
    it('should throw for null/undefined', () => {
      expect(() => validateIdentifier(null as unknown as string, 'table')).toThrow(
        SqlSanitizationError
      )
      expect(() => validateIdentifier(undefined as unknown as string, 'table')).toThrow(
        SqlSanitizationError
      )
    })
...
describe('escapeTypedIdentifier', () => {
  ...
  it('should apply type-specific length limits', () => {
    ...
    expect(() => escapeTypedIdentifier(longName, 'database', 'postgres')).toThrow(
      SqlSanitizationError
    )
...
describe('escapeQualifiedIdentifier', () => {
  ...
  it('should throw for invalid schema names', () => {
    expect(() => escapeQualifiedIdentifier("bad'schema", 'users', 'postgres')).toThrow(
      SqlSanitizationError
    )
  })

  it('should throw for invalid table names', () => {
    expect(() => escapeQualifiedIdentifier('public', "bad'table", 'postgres')).toThrow(
      SqlSanitizationError
    )
  })
})
...
describe('validateIdentifiers', () => {
  ...
  it('should throw on first invalid identifier', () => {
    expect(() => validateIdentifiers(['users', "bad'table", 'orders'], 'table')).toThrow(
      SqlSanitizationError
    )
  })
...
describe('safeDropDatabase', () => {
  ...
  it('should throw for invalid database names', () => {
    expect(() => safeDropDatabase("db'; DROP DATABASE --", 'postgres')).toThrow(
      SqlSanitizationError
    )
  })
})
...
describe('safeVacuumInto', () => {
  ...
  it('should allow paths with various characters', () => {
    ...
    expect(safeVacuumInto('C:\\Users\\test\\backup.db')).toBe(
      "VACUUM INTO 'C:\\Users\\test\\backup.db'"
    )
  })
  ...
  it('should throw for paths with semicolons', () => {
    expect(() => safeVacuumInto('/path/to/backup.db; DROP TABLE users')).toThrow(
      SqlSanitizationError
    )
  })
