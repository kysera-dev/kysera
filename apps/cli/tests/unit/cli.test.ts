...
describe('CLI', () => {
  ...
  describe('Subcommand Structure', () => {
    it('should support nested subcommands', () => {
      ...
      const childCmd = new Command('child').description('Child command').action(() => {})
  ...
  describe('Async Actions', () => {
    it('should support async command actions', async () => {
      ...
      const testCmd = new Command('asynctest').description('Async test').action(async () => {
    ...
    it('should handle async errors properly', async () => {
      const testCmd = new Command('asyncerror').description('Async error test').action(async () => {
      ...
      await expect(program.parseAsync(['node', 'kysera', 'asyncerror'])).rejects.toThrow(
