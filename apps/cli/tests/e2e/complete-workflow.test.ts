...
describe('Complete CLI Workflow E2E', () => {
  ...
  it('should complete full project lifecycle', async () => {
    ...
    const createMigration1 = runCLISync(['migrate', 'create', 'create_users_table'], {
      cwd: projectDir
    })
    ...
    const createMigration2 = runCLISync(['migrate', 'create', 'create_posts_table'], {
      cwd: projectDir
    })
    ...
    const listResult = runCLISync(['migrate', 'list'], { cwd: projectDir })
