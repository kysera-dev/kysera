...
| ------------------- | ------- | -------- | ------- | ----- | ------ |
| @kysera/core        | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/executor    | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/repository  | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/dal         | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/dialects    | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/infra       | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/debug       | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/testing     | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/migrations  | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/soft-delete | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/timestamps  | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/audit       | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
| @kysera/rls         | 0.8.7   | >=0.29.0 | >=20    | >=1.0 | >=1.40 |
